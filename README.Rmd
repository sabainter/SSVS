...
The estimates of SSVS_MI result can be summarized by using `summary.mi()` function. This will display average, minimum, and maximum of estimates, MIP and average nonzero beta for each coefficient.
