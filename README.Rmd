...
The results can be summarized and printed using the summary_SSVS() function. This will display both the MIP
...
The MIPs for each predictor can then be visualized using the plot_SSVS() function.
